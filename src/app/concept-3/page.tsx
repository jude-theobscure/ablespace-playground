...
<div className="max-w-[1200px] mx-auto px-6 pt-24 pb-20 flex flex-col items-center text-center relative z-10">
        ...
        <div className="mt-8 flex items-center gap-4">
          <Image src="/assets/icons/security/Navbar/FERPA Compliant 1.png" alt="FERPA Compliant" width={90} height={36} className="h-9 w-auto" style={{ filter: "brightness(0)", opacity: 0.35 }} />
          <Image src="/assets/icons/security/Navbar/HIPAA 1.png" alt="HIPAA" width={90} height={36} className="h-9 w-auto" style={{ filter: "brightness(0)", opacity: 0.35 }} />
          <Image src="/assets/icons/security/Navbar/ISO 27001 Certified 1.png" alt="ISO 27001 Certified" width={90} height={36} className="h-9 w-auto" style={{ filter: "brightness(0)", opacity: 0.35 }} />
        </div>
      ...
      <section className="w-full py-20">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex items-center justify-between pl-10">
            <div style={{ width: 480 }}>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[8px] mb-4" style={{ background: "#DDF7D1" }}>
                ...
                <span className="text-sm font-semibold text-[#6CA751]">IEP Tracking</span>
              </div>
              <h2
